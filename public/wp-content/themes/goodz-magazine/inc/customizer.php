...
function goodz_magazine_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control( 'blog_header_transparency_enable', array(
        ...
        'label'    => esc_html__( 'Check to enable header transparency', 'goodz-magazine' ),
        'section'  => 'colors',
        'type'     => 'checkbox'
    ) );
    ...
    $wp_customize->add_setting( 'goodz_magazine_navigation_hover_color', array(
        'default'           => '#808080',
        'sanitize_callback' => 'goodz_magazine_sanitize_color'
    ));
    ...
    $wp_customize->add_control(
        ...
        array(
            'label'    => esc_html__( 'Navigation Hover Color', 'goodz-magazine' ),
            'section'  => 'colors',
            'settings' => 'goodz_magazine_navigation_hover_color',
        ) )
    );


    // Transparent Header Navigation color
    $wp_customize->add_setting( 'goodz_magazine_tr_navigation_color', array(
        'default'           => '#000',
        'sanitize_callback' => 'goodz_magazine_sanitize_color'
    ));
    ...
    $wp_customize->add_control(
        ...
        array(
            'label'    => esc_html__( 'Transparent Header - Navigation Color', 'goodz-magazine' ),
            'section'  => 'colors',
            'settings' => 'goodz_magazine_tr_navigation_color',
        ) )
    );
    ...
    // Logo hover color
    $wp_customize->add_setting( 'goodz_magazine_logo_hover_color', array(
        'default'           => '#808080',
        'sanitize_callback' => 'goodz_magazine_sanitize_color'
    ));
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'section'  => 'colors',
            'settings' => 'goodz_magazine_logo_hover_color',
        ) )
    );

    // Logo description color
    $wp_customize->add_setting( 'goodz_magazine_logo_description_color', array(
        'default'           => '#000',
        'sanitize_callback' => 'goodz_magazine_sanitize_color'
    ));
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'section'  => 'colors',
            'settings' => 'goodz_magazine_logo_description_color',
        ) )
    );
