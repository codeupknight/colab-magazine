...
class Themes_Kingdom_Theme_Demo_Data_Importer {
	...
	public function demo_installer() {
		?>
			...
			<div class="wrap">
				<h2><span class="dashicons dashicons-update" style="line-height: 29px;"></span>Import Sample Data</h2>
				<div id="message" class="updated notice notice-success is-dismissible">
					<p>You can speed up development of your site by importing our sample site content like posts and images.</p>

					<p>Each demo site comes with sample posts, pages, some images, some widgets and menus.</p>

					<p>Pick a demo site, click the import button, and wait. It can take a couple of minutes to import everything we have.</p>

					<p><strong>Please note:</strong><br/>
					The imported images are copyrighted and are for demo use only. Please replace them with your own images after importing.</p>

					<p><strong>Before you begin:</strong><br/>
					Make sure all the required plugins are activated.</p>
				</div>
	...
	public function set_main_menu() {
		...
		$social_menu  = get_term_by('name', $this->social_menu_name, 'nav_menu');
	...
	public function import_widgets( $data ) {
		...
		foreach ( $data as $sidebar_id => $widgets ) {
			...
			foreach ( $widgets as $widget_instance_id => $widget ) {
				...
				$results[$sidebar_id]['widgets'][$widget_instance_id]['title'] = ! empty( $widget->title ) ? $widget->title : esc_html__( 'No Title', 'tk' ); // show "No Title" if widget instance is untitled
