...
function goodz_magazine_setup() {
	...
	add_image_size( 'goodz-magazine-single-featured-image', 500, 300, true );
	...
	register_nav_menus( array(
		...
		'business' => esc_html__( 'Business', 'goodz-magazine' ),
	) );
...
function my_styles(){
	...
	wp_enqueue_script( 'bootstrap-jquery', get_stylesheet_directory_uri() . 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js' );
